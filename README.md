...
1. Clone the repository:
   ```bash
   git clone https://xenonhub-kfbaaxzf.manus.space/S754-gacha.git
   cd S754-gacha
   ```
...
3. Website will be live at: `https://xenonhub-kfbaaxzf.manus.space/S754-gacha`

### Vercel
1. Connect repository to Vercel
2. Deploy automatically
3. Website will be live at: `https://S754-gacha.vercel.app`

### Netlify
1. Connect repository to Netlify
2. Deploy automatically
3. Website will be live at: `https://S754-gacha.netlify.app`
